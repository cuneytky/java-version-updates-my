...
public class SwitchCaseDemo {
    public static void main(String[] args) {
        ...
        switch (month) {
            ...
            case 6:
            case 9:
                System.out.println("this month has 30 days");       // this month has 30 days
                break;
            case 2:
        ...
        switch(month){
            ...
            case 4,6,9 -> System.out.println("This month has 30 days");   // This month has 30 days
        ...
        System.out.println("day1: "+day1); // day1: 30
...
// yield ile fazla line ve alternatif kullanabılırız
                if(year %4 == 0)
                    yield 29;
                else
                    yield 28;
        ...
        System.out.println("day2: "+day2); //day2: 30
    }
}
